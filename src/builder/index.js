  ...
  return (
    <div className="builder-app">
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="flex">
          <div className="w-2/3 h-screen overflow-y-scroll overflox-x-hidden">
            <FilterTags setFilter={setFilter} filter={filter} />
            <Library items={filteredItems} deleteMe={deleteMe} />
          </div>
          <div className="w-1/3 h-screen overflow-y-scroll overflox-x-hidden bg-gray-100 border-l border-gray-500">
            <Compiled
              items={items}
              setItems={setItems}
              deleteMe={deleteMe}
